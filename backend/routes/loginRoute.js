...
router.post('/login', async (req, res) => {
  try {
    ...
    const idToken = encryptToken(generateToken({ iss: process.env.JWT_ISSUER, uniqueId: global.uniqueId, employeeId: user.employeeId }, '1m')); // Including the uniqueId in the idToken
